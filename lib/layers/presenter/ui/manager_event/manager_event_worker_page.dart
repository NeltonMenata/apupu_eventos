...
class ManagerEventWorkerPage extends StatefulWidget {
  const ManagerEventWorkerPage({Key? key}) : super(key: key);

  @override
  State<ManagerEventWorkerPage> createState() => _ManagerEventWorkerPageState();
}

class _ManagerEventWorkerPageState extends State<ManagerEventWorkerPage> {
  ...
  Widget build(BuildContext context) {
    final workerObjectId = ModalRoute.of(context)!.settings.arguments as String;
